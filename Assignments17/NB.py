...
sms = pd.read_csv("C:\\Home\\Downloads\\sms_raw_NB.csv",encoding= 'latin-1')
...
with open("C:\\Home\\Downloads\\stop.txt","r") as sw:
    stopwords = sw.read()
...
saltrain = pd.read_csv("C:\\Home\\Downloads\\SalaryData_Train.csv")
